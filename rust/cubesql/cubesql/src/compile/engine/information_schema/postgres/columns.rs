...
use super::{
    ...
    utils::{new_int32_array_with_placeholder, new_string_array_with_placeholder},
};
...
impl InformationSchemaColumnsBuilder {
    ...
    fn add_column(
        ...
        self.table_schema
            ...
            .unwrap();
        self.table_name.append_value(table_name.as_ref()).unwrap();
        ...
        self.is_nullable
            .append_value(column.get_is_nullable())
            .unwrap();
        self.data_type.append_value(column.get_data_type()).unwrap();
        self.character_maximum_length.append_null().unwrap();
        match column.get_char_octet_length() {
            Some(value) => self.character_octet_length.append_value(value).unwrap(),
            _ => self.character_octet_length.append_null().unwrap(),
        }
...
impl TableProvider for InfoSchemaColumnsProvider {
    ...
    fn schema(&self) -> SchemaRef {
        Arc::new(Schema::new(vec![
            ...
            Field::new("is_self_referencing", DataType::Utf8, false),
            ...
            Field::new("identity_cycle", DataType::Utf8, false),

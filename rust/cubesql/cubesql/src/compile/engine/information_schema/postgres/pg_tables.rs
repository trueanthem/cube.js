...
impl PgCatalogTablesBuilder {
    ...
    fn add_table(
        ...
        self.schemaname.append_value(schemaname.as_ref()).unwrap();
        self.tablename.append_value(tablename.as_ref()).unwrap();
        self.tableowner.append_value(tableowner.as_ref()).unwrap();
    }

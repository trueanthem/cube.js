...
struct PgStatActivityBuilder {
    ...
    state: StringBuilder,
    backend_xid: Int32Builder,
    backend_xmin: Int32Builder,
...
impl PgStatActivityBuilder {
    fn new(capacity: usize) -> Self {
        Self {
            ...
            usesysid: Int32Builder::new(capacity),
            ...
            backend_xid: Int32Builder::new(capacity),
            backend_xmin: Int32Builder::new(capacity),
...
impl TableProvider for PgCatalogStatActivityProvider {
    ...
    fn schema(&self) -> SchemaRef {
        Arc::new(Schema::new(vec![
            ...
            Field::new("usesysid", DataType::Int32, true),
            ...
            Field::new("backend_xid", DataType::Int32, true),
            Field::new("backend_xmin", DataType::Int32, true),
